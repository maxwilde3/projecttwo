...
var geoData2 = "static/data/boroughs1.geojson";
//var geoData3 = "static/data/boroughsandpassrate.geojson"
...
d3.json(geoData2, function(data) {
  ...
  var geojson2 = L.choropleth(data, {
    ...
    // Binding a pop-up to each layer
    onEachFeature: function(feature, layer) {
      layer.bindPopup("Borough: " + feature.properties.BoroName +
                      "<br>Test Score:<br>" +
                      feature.properties.Shape_Area + "%");   // this value is a placeholder
    }
  });
...
function createMap(geojson2) {
  ...
  var myMap = L.map("map", {
    ...
    legend2.onAdd = function() {
      ...
      // Add min & max
      var legendInfo = "<h1>ELA State Test Score</h1>" +
        "<div class=\"labels\">" +
